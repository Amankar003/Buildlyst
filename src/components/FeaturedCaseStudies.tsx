        ...
        <div className="mip-cards-grid">
          <div className="glass-panel glowing-card mip-card-split">
            ...
            <div className="mip-split-left">
              <Image src={featuredCase.imageSrc} alt={`${featuredCase.title} — ${featuredCase.subDomain} project by Buildlyst`} fill sizes="(max-width: 768px) 100vw, 50vw" className="mip-card-img" />
