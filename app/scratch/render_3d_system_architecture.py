...
<div style="min-height: 100vh;">
    ...
    <!-- 5. 3D GLASSMORTIC ISOMETRIC ANIMATED SYSTEM DESIGN DIAGRAM (ATTRACTS BOTH TECH & NON-TECH) -->
...
<!-- DYNAMIC TELEMETRY + 3D ISOMETRIC ARCHITECTURE SCRIPTS -->
<script>
...
function select3dNode(index) {{
    ...
    // Remove active class from 3D nodes
...
# 5 Detailed Services Data with 3D ISOMETRIC ARCHITECTURE + PLAIN ENGLISH EXPLANATIONS
services_data = [
    {
...
print("3D GLASSMORPHIC ISOMETRIC ANIMATED SYSTEM DESIGN DIAGRAM DEPLOYED PERFECTLY!")
