...
# 1. Update base.html with block back_button and smart Navbar for service pages
...
# 2. Update services_layout.html to inject fixed top-left Back to Home button
...
<div style="position: fixed; top: 85px; left: 24px; z-index: 99999;">
    <a href="/" class="btn glass-btn" style="padding: 10px 20px; font-size: 13px; font-weight: 700; display: inline-flex; align-items: center; gap: 8px; border-radius: 50px; border: 1.5px solid rgba(0, 210, 255, 0.4); background: rgba(5, 12, 28, 0.94); color: #fff; box-shadow: 0 8px 30px rgba(0,0,0,0.7), 0 0 20px rgba(0, 210, 255, 0.3); backdrop-filter: blur(12px); text-decoration: none; transition: all 0.3s ease;"
       onmouseover="this.style.transform='translateY(-2px) scale(1.05)'; this.style.borderColor='#00d2ff'; this.style.boxShadow='0 12px 35px rgba(0, 210, 255, 0.5)';"
       onmouseout="this.style.transform='translateY(0) scale(1)'; this.style.borderColor='rgba(0, 210, 255, 0.4)'; this.style.boxShadow='0 8px 30px rgba(0,0,0,0.7), 0 0 20px rgba(0, 210, 255, 0.3)';">
...
print("BASE.HTML & SERVICES LAYOUT UPDATED WITH SMART NAV BAR AND STICKY BACK BUTTON!")
